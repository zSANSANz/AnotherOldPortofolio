    ...
    <div class="container">
        ...
        <nav class="collapse navbar-collapse">
            <ul class="nav navbar-nav navbar">
                ...
                <li><a href="<?php echo site_url('wizard'); ?>">Diagnosa Kerusakan Mesin</a></li>
                <?php if ($this->ion_auth->logged_in()): ?>
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="<?php echo site_url('kerusakan'); ?>">Kelola Kerusakan</a></li>
                ...
                <?php if ($this->ion_auth->logged_in()): ?>
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="<?php echo site_url('site/laporanAdmin'); ?>">Laporan Admin</a></li>
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="user dropdown">
                    <?php if (!$this->ion_auth->logged_in()): ?>
                        <a href="<?php echo site_url('auth/login'); ?>" rel="async"
                           ajaxify="<?php echo site_url('auth/auth_ajax/ion_auth_dialog/login'); ?>">
                    ...
                    <?php else: ?>
                        ...
                        <?php if (!empty($user)): ?>
                            ...
                            <div class="panel dropdown-menu dropdown-menu-right" style="width:300px">
                                <ul class="dropdown-menu">
                                    ...
                                    <li>
                                        <a href="<?php echo site_url('auth/change_password'); ?>"
                                           rel="async"
                                           ajaxify="<?php echo site_url('auth/auth_ajax/ion_auth_dialog/change_password'); ?>"
                                        >
                                            Change password
                                        </a>
                                    </li>
                                ...
                                <div class="well ">
                                    <?php foreach (['id', 'email', 'first_name', 'last_name'] as $field): ?>
