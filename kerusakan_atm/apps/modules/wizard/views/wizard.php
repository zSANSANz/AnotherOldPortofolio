<div class="row" style="margin-top:20px;">
    ...
    <form id="question" role="form" method="post" action="<?php echo base_url('wizard/proses_inferensi'); ?>">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <h3>Gejala Kerusakan Mesin</h3>
            <h5>Centanglah gejala di bawah ini yang sesuai yang anda alami!</h5>
        </div>
                ...
                foreach ($data as $key => $value) {?>
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                        ...
                        <label class="btn btn-md btn-block btn-info" style="text-align:left"><span class="text-left">
                            ...
                            <span style="margin-left:0px;" ><?php echo $value['gejala'] ?></span>
                            </span>
                        </label>
                    </div>
                <?php }
        ...
        <div class="col-md-12 text-center" style="margin-top:30px">
            <button id="save" class="btn btn-danger btn-lg btn-block nextBtn" type="submit">Prosses</button>
