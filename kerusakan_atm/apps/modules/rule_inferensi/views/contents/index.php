                                            ...
                                            <div id="form_input" class="">
                                                ...
                                                <div class="row">
                                                    <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
                                                        <input type="hidden" value='' id="id_kerusakan_gejala" name="id_kerusakan_gejala">
                                                        

                                                        
                                                        <div class="form-group">
                                                                <?php echo form_label('id_kerusakan : ','id_kerusakan',array('class'=>'control-label')); ?>
                                                                <div class="controls">
                                                                    <?php //echo form_input('id_kerusakan','','id="id_kerusakan" class="form-control" placeholder="Enter id_kerusakan"'); ?>
                                                                    <?php echo form_dropdown('id_kerusakan',$kerusakan,'','id="id_kerusakan" class="form-control"'); ?>
                                                                </div>
                                                        </div>
                                                    </div>  
