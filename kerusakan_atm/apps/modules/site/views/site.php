...
<div class="jumbotron">
	<div class="container text-center">
		<h1>Sistem Pakar Kerusakan ATM</h1>
		<h3>Menggunakan Metode Dempster Shafer</h3>
		<p>&nbsp;</p>
		<p>
			<a href="<?php echo base_url('wizard') ?>" class="btn btn-danger btn-lg">Diagnosa Kerusakan ATM</a>
		</p>
	</div>
</div>
<?php else: ?>
	<div class="row">
		...
		<h1>Laporan Sistem Pakar Kerusakan ATM</h1>
		<h3>Menggunakan Metode Dempster Shafer</h3>
		<hr>
		<?php echo $data; ?>
	</div>
