    ...
    <div class="content">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card-box">
                        <a href="#dataTableTokenizing" class="btn btn-danger waves-effect w-md waves-light m-b-5">Tokenizing</a>
                        <a href="#dataTableFiltering" class="btn btn-success waves-effect w-md waves-light m-b-5">Filtering</a>
                        <a href="#dataTableRemoveDuplikat" class="btn btn-primary waves-effect w-md waves-light m-b-5">Stemming</a>
                    </div>
                </div><!-- end col -->
            </div>
            <!-- end row -->
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card-box">
                                ...
                                <table id="1dataTableRemoveDuplikat" class="table table-striped table-bordered">
                                    <thead>
                                    <tr>
