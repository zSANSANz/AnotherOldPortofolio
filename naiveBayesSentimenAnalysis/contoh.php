                ...
                <ul class="nav navbar-nav navbar-right pull-right">
                    ...
                    <li class="dropdown user-box">
                        <a href="" class="dropdown-toggle waves-effect waves-light profile " data-toggle="dropdown" aria-expanded="true">
                            <img src="assets/adminto-14/Admin/Horizontal/assets/images/users/avatar-1.jpg" alt="user-img" class="img-circle user-img">
            ...
            <ul class="list-group list-no-border user-list">
                <li class="list-group-item">
                    <a href="#" class="user-list-item">
                        <div class="avatar">
                            <img src="assets/adminto-14/Admin/Horizontal/assets/images/users/avatar-2.jpg" alt="">
                        </div>
                        <div class="user-desc">
                ...
                <li class="list-group-item active">
                    <a href="#" class="user-list-item">
                        <div class="avatar">
                            <img src="assets/adminto-14/Admin/Horizontal/assets/images/users/avatar-3.jpg" alt="">
                        </div>
                        <div class="user-desc">
