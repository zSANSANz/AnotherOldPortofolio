    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="page-scroll">
                    <a href="<?php echo site_url('cLogin/') ?>">Log In<span
                            class="sr-only">(current)</span></a>
                </li>
                <li class="page-scroll">
                    <a href="<?php echo site_url('cLogin/logout') ?>">Log Out<span
                            class="sr-only">(current)</span></a>
...
<section class="success" id="petunjuk">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-6 portfolio-item">
                       <p>Menu, beriskan 5 tombol menu pembelajaran</p>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-sm-9 portfolio-item">
                        <p>Home, yaitu tombol untuk kembali ke halama awal menu pembelajaran</p>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-sm-9 portfolio-item">
                        <p>Pembelajaran, yaitu tombol untuk mengakses materi pembelajaran</p>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-sm-9 portfolio-item">
                        <p>Evaluasi, yaitu tombol untuk menuju soal yang digunakan untuk mengetahui kemampuan pemahaman siswa seluruh KD</p>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-sm-3 portfolio-item">
                        <a href="#">
                            ...
                            <p class="glyphicon glyphicon-expand"></p>

                        </a>
                    </div>

                    <div class="col-sm-9 portfolio-item">
                        <p>Simulasi, yaitu tombol yang digunakan untuk berpindah halaman ke bagian simulasi pembelajaran</p>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-sm-3 portfolio-item">
                        <a href="#">
                            ...
                            <p class="glyphicon glyphicon-question-sign"></p>

                        </a>
                    </div>

                    <div class="col-sm-9 portfolio-item">
                        <p>About, tombol yang digunakan untuk mengetahui petunjuk penggunaan media dan kontak pembuat media pembelajaran</p>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-sm-3 portfolio-item">
                        <a href="#">
                            ...
                            <img src="<?php echo base_url() ?>assets/bintang/img/portfolio/1.png"
                                 ...
                                 alt="" title="Materi Satu (1)">

                        </a>
                    </div>

                    <div class="col-sm-9 portfolio-item">
                        <br /><br /><p>Tombol materi satu(1)</p>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-3 portfolio-item">
                        <a href="#">
                            ...
                            <img src="<?php echo base_url() ?>assets/bintang/img/portfolio/2.png"
                                 class="img-responsive"
                                 alt="" title="Materi Dua (2)">
                        </a>
                    </div>
                    <div class="col-sm-9 portfolio-item">
                        <br /><br /><p>Tombol materi dua(2)</p>
                    </div>
                </div>
                    ...
                    <div class="col-sm-3 portfolio-item">
                        <a href="#">
                            ...
                            <img src="<?php echo base_url() ?>assets/bintang/img/portfolio/3.png"
                                 class="img-responsive"
                                 alt="" title="Materi Tiga (3)">
                        </a>
                    </div>
                    <div class="col-sm-9 portfolio-item">
                        <br /><br /><p>Tombol materi tiga(3)</p>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-3 portfolio-item">
                        <a href="#">
                            ...
                            <img src="<?php echo base_url() ?>assets/bintang/img/portfolio/4.png"
                                 class="img-responsive"
                                 alt="" title="Materi Empat (4)">
                        </a>
                    </div>
                    <div class="col-sm-9 portfolio-item">
                        <br /><br /><p>Tombol materi empat(4)</p>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-3 portfolio-item">
                        <a href="#">
                            ...
                            <img src="<?php echo base_url() ?>assets/bintang/img/portfolio/5.png"
                                 class="img-responsive"
                                 alt="" title="Materi Empat (4)">
                        </a>
                    </div>
                    <div class="col-sm-9 portfolio-item">
                        <br /><br /><p>Tombol materi empat(5)</p>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-9 portfolio-item">
                        <br /><br /><p>Tombol materi empat(6)</p>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-5 portfolio-item">
                        <a href="#">
                            ...
                            <img src="<?php echo base_url() ?>assets/bintang/img/portfolio/hd/me.jpg"
                                 class="img-responsive"
                                 alt="" title="Materi Satu (1)">
                        </a>
                    </div>
