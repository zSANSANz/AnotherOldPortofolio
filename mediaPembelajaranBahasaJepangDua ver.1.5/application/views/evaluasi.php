                        ...
                        <div class="eleven column omega tabwrapper">
                            <div class="menu-wrapper">
                                <ul class="tabs menu">
                                    ...
                                    <li><a href="<?php echo base_url() ?>index.php/welcome/beranda"><i class="glyphicon glyphicon-list"> Pembelajaran</i></a>
                                        <ul class="child">
                                    ...
                                    <li><a href="<?php echo site_url('welcome/evaluasi') ?>" class="active"><i class="glyphicon glyphicon-expand"> Evaluasi</i></a>
                                        <ul class="child">
