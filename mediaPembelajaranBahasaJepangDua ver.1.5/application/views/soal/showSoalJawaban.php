        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav navbar-right">
                <li class="page-scroll">
                    <a href="<?php echo site_url('cManipulasiSoal/index') ?>">Lihat Soal<span
                            class="sr-only">(current)</span></a>

                </li>
                <li class="page-scroll">
                    <a href="<?php echo site_url('cManipulasiSoal/showSoal') ?>">Manipulasi Soal<span
                            class="sr-only">(current)</span></a>

                </li>
                <li class="page-scroll">
                    <a href="<?php echo site_url('cManipulasiSoal/showJawaban') ?>">Manipulasi Jawaban<span
                            class="sr-only">(current)</span></a>

                </li>
                <li class="page-scroll">
                    <a href="<?php echo site_url('cManipulasiSoal/showNilai') ?>">Hasil Nilai<span
                            class="sr-only">(current)</span></a>
            ...
            <div class="row">
                ...
                <div class="body-wrapper">
                    ...
                    <div class="content">
                        ...
                        <table id="example" class="table table-striped table-bordered"><h1>BANK
                                SOAL</h1>
                            <thead>
                            <tr>
                                <th>id jawaban</th>
                            ...
                            <?php
                            $i = 1;
                            foreach ($data_soal as $lihat)
                            {
                            ?>
                            <tr>
                                <td><?php echo $lihat->id_jawaban; ?></td>
                                <td><?php echo $lihat->id_soal; ?></td>
                                <td><?php echo $lihat->jawaban; ?></td>
                                <td><?php echo $lihat->benar; ?></td>

                                <td>
                                    <a href="<?php echo base_url() . 'index.php/cManipulasiSoal/editJawaban/' . $lihat->id_jawaban; ?>"
                                       class="btn btn-primary">
                                        <span class="glyphicon glyphicon-pencil"></span>
                                    </a>
                                    <a href="<?php echo base_url() . 'index.php/cManipulasiSoal/hapusJawaban/' . $lihat->id_jawaban; ?>"
                ...
                <?php echo anchor(base_url() . 'index.php/cManipulasiSoal/tambahJawaban', '<input type="button" class="btn btn-primary" value="tambah">'); ?>
            </div>
        </div>
    </div>
