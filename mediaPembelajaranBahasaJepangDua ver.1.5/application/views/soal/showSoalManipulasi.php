    ...
    <div class="sub-head">
        ...
        <div class="body">
            ...
            <div class="row">
                    ...
                    <div class="content">
                        ...
                        <table id="example" class="table table-striped table-bordered"><h1>BANK
                            ...
                            <tr>
                                ...
                                <td><?php echo $lihat->soal; ?></td>
                                <td><?php echo $lihat->id_materi; ?></td>

                                <td>
                                    <a href="<?php echo base_url() . 'index.php/cManipulasiSoal/edit/' . $lihat->id_soal; ?>"
                                       class="btn btn-primary">
                                        <span class="glyphicon glyphicon-pencil"></span>
                                    </a>
                                    <a href="<?php echo base_url() . 'index.php/cManipulasiSoal/hapus/' . $lihat->id_soal; ?>"
                ...
                <?php echo anchor(base_url() . 'index.php/cManipulasiSoal/tambah', '<input type="button" class="btn btn-primary" value="tambah">'); ?>
            </div>
        </div>
    </div>
