                    ...
                    <div class="content">
                        <div class="container callout">
                            ...
                            <div class="twelve columns">
                                ...
                                <h1>Tambah Soal</h1>
                                <form method="post"
                                      action="<?php echo base_url() . 'index.php/cManipulasiSoal/tambah_act' ?>">
                                    <div class="form-group">
                                        <label for="username">Deskripsi Soal</label>
                                        <textarea class="form-control" id="soal" name="soal"
                                                  placeholder="tulisakan soal" name="deskripsi_soal"
                                                  value="deskripsi_soal"
                                    ...
                                    <div class="form-group">
                                        <label for="kriteriaSoal">Kriteria Soal</label>
                                        <select name="id_materi" multiple class="form-control">
                                            ...
                                            <option value="4">Materi Empat</option>
                                            <option value="5">Materi Lima</option>
                                            <option value="6">Materi Enam</option>
                                        </select>
                                    </div>
