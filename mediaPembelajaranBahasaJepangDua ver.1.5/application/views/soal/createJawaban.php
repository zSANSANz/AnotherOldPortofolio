                    ...
                    <div class="content">
                        <div class="container callout">
                            ...
                            <div class="twelve columns">
                                <h1>Tambah Soal</h1>
                                <form method="post"
                                      action="<?php echo base_url() . 'index.php/cManipulasiSoal/tambahJawaban_act' ?>">
                                    <div class="form-group">
                                        <label for="id_cluster">calon mahasiswa</label>
                                        <select name="id_soal" multiple class="form-control">
                                            <?php foreach($soal as $rs_soal) { ?>
                                                <option value="<?php echo $rs_soal->id_soal;?>" <?php echo set_select('calon_mahasiswa',$rs_soal->id_soal);?> />
                                                <?php echo $rs_soal->id_soal;?>	 :: <?php echo $rs_soal->soal;?>
                                            <?php } ?>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="jawaban" name="jawaban"
                                                  placeholder="tulisakan jawaban" name="jawaban"
                                                  value="jawaban"
                                                  style="min-width: 100%; max-height: 100%;min-width: 100%; max-height: 100%; margin: 0px -193.003px 0px 0px; width: 930px; height: 483px;">  </textarea>
                                    </div>

                                    <div class="form-group">
                                        <label for="jawabanBenar">Status Jawaban</label>
