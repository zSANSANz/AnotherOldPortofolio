                        ...
                        <div class="container callout">
                            ...
                            <div class="twelve columns">
                                ...
                                <?php foreach ($data_edit as $tes) {
                                    ...
                                    <form method="post"
                                          action="<?php echo base_url() . 'index.php/cManipulasiSoal/editJawaban_act' ?>">
                                        <input type="hidden" name="id_jawaban" id="id_jawaban"
                                               value="<?php echo $tes->id_jawaban ?>"/>
                                        <div class="form-group">
                                            <label for="username">Deskripsi Soal</label>
                                            <input class="form-control" type="text" id="id_soal" name="id_soal" value="<?php echo $tes->id_soal; ?>" disabled />
                                        </div>

                                        <div class="form-group">
                                            <label for="username">Deskripsi Jawaban</label>
                                            <textarea class="form-control" id="jawaban" name="jawaban"
                                                      placeholder="<?php echo $tes->jawaban ?>" name="jawaban"
                                                      value="<?php echo $tes->jawaban ?>"
                                                      style="min-width: 100%; max-height: 100%;min-width: 100%; max-height: 100%; margin: 0px -193.003px 0px 0px; width: 930px; height: 483px;"><?php echo $tes->jawaban ?> </textarea>
                                        </div>

                                        <div class="form-group">
                                            <select name="benar" multiple class="form-control">

                                                <option value="0" <?php if ($tes->benar == "0") {
                                                    echo 'selected';
                                                } ?>>Salah
                                                </option>
                                                <option value="1" <?php if ($tes->benar == "1") {
                                                    echo 'selected';
                                                } ?>>Benar
                                                </option>
