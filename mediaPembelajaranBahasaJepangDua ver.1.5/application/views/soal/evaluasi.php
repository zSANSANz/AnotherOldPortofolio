...
<div class="header">
    <div class="container">
        ...
        <div class="header_bottom">
            <h1 class="m_head wow rollIn" data-wow-delay="0.4s">Evaluasi<br>Materi Satu(1) sampai dengan Materi(6)</h1>
            <div class="video_buttons">
                <div class="video_but"> <a href="#" class="fa-btn btn-1 btn-1e">Selamat Mengerjakan</a></div>
        ...
        <div class="container">
            ...
            <div class="wmuSlider example1">
                <div class="wmuSliderWrapper">
                    <form method="post" action="<?php echo base_url() . 'index.php/cSoalAcak/hasil' ?>">

                        <input type="hidden" id="point" name="point" value="5">
                        <input type="hidden" id="materi" name="materi" value="0">
