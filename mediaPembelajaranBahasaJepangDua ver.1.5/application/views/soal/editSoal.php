                        ...
                        <div class="container callout">
                            ...
                            <div class="twelve columns">
                                ...
                                <?php foreach ($data_edit as $tes) {
                                    ...
                                    <form method="post"
                                          action="<?php echo base_url() . 'index.php/cManipulasiSoal/edit_act' ?>">
                                        <input type="hidden" name="id_soal" id="id_soal"
                                               value="<?php echo $tes->id_soal ?>"/>
                                        <div class="form-group">
                                            <label for="username">Deskripsi Soal</label>
                                            <textarea class="form-control" id="soal" name="soal"
                                                      placeholder="<?php echo $tes->soal ?>" name="soal"
                                                      value="<?php echo $tes->soal ?>"
                                                      style="min-width: 100%; max-height: 100%;min-width: 100%; max-height: 100%; margin: 0px -193.003px 0px 0px; width: 930px; height: 483px;"><?php echo $tes->soal ?> </textarea>
                                        </div>

                                        <div class="form-group">
                                            <select name="id_materi" multiple class="form-control">

                                                <option value="1" <?php if ($tes->id_materi == "1") {
                                                    echo 'selected';
                                                } ?>>Materi Satu
                                                </option>
                                                <option value="2" <?php if ($tes->id_materi == "2") {
                                                    echo 'selected';
                                                } ?>>Materi Dua
                                                </option>
                                                <option value="3" <?php if ($tes->id_materi == "3") {
                                                    echo 'selected';
                                                } ?>>Materi Tiga
                                                </option>
                                                <option value="4" <?php if ($tes->id_materi == "4") {
                                                    echo 'selected';
                                                } ?>>Materi Empat
                                                </option>
                                                <option value="5" <?php if ($tes->id_materi == "5") {
                                                    echo 'selected';
                                                } ?>>Materi Lima
                                                </option>
                                                <option value="6" <?php if ($tes->id_materi == "6") {
                                                    echo 'selected';
                                                } ?>>Materi Enam
                                                </option>
