            ...
            <div class="row">
                ...
                <div class="body-wrapper">
                    ...
                    <div class="content">
                        ...
                        <table id="example" class="table table-striped table-bordered"><h1>Nilai Kompetnsi yang Telah dikerjakan</h1>
                            <thead>
                            <tr>
                                <th>no</th>
                                <th>username</th>
                            ...
                            <tr>
                                ...
                                <td><?php
                                    ...
                                    if ($lihat->materi==0) {
                                        echo "evaluasi";
                                    } else if ($lihat->materi==1) {
                                        echo "Materi Satu";
                                    } else if ($lihat->materi==2) {
                                        echo "Materi Dua";
                                    } else if ($lihat->materi==3) {
                                        echo "Materi Tiga";
                                    } else if ($lihat->materi==4) {
                                        echo "Materi Empat";
                                    }
