                    ...
                    <div class="content">
                        <div class="container callout">
                            ...
                            <div class="twelve columns">
                                ...
                                <form method="post" action="<?php echo base_url().'index.php/cLogin/tambah_act' ?>">
                                    ...
                                    <div class="callout-hr"></div>
                                    <input type="hidden" name="hakakses" id="hakakses" value="siswa">
                                    <input type="submit" value="Daftar" class="btn btn-primary" ></td>
                                </form>
        ...
        <div class="content">
            ...
            <div class="container">
                            ...
                            <a href="<?php echo site_url('cBabSatu/babSatuMateri') ?>">
                                <div class="icon client">
                                    <div class="content">
                                        ...
                                        <h5>Materi Satu(1)</h5>
                                        <span class="hr"></span>
                                        <p>Sistem file dan user access pada linux </p>
                                    </div>
                                </div>
                            </a>
                        </li>
                            ...
                            <a href="<?php echo site_url('cBabTiga/babTigaMateri') ?>">
                                <div class="icon globe">
                                    <div class="content">
                                        ...
                                        <h5>Materi Tiga(3)</h5>
                                        <span class="hr"></span>
                                        <p>Manajemen Backup dan Recovery </p>
                                    </div>
                                </div>
                            </a>
                        </li>
                        ...
                        <li class="columns last-child">
                            <a href="<?php echo site_url('cBabEmpat/babEmpatMateri') ?>">
                                <div class="icon iphone">
                                    <div class="content">
                                        <div class="symbol"></div>
                                        <h5>Materi Empat(4)</h5>
                                        <span class="hr"></span>
                                        <p>Manajemen Remote Access</p>
                                    </div>
                                </div>
                            </a>
                        </li>
                ...
                <div class="sixteen circles columns">
                    <ul>
                        <li class="columns">
                            <a href="<?php echo site_url('cSoal/indexSatu') ?>">
                                <div class="icon trophy">
                                    <div class="content">
                                        <div class="symbol"></div>
                                        <h5>Evaluasi Satu(1)</h5>
                                        <span class="hr"></span>
                                        <p>Sistem file dan user access pada linux </p>
                                    </div>
                                </div>
                        ...
                        <li class="columns">
                            <a href="<?php echo site_url('cSoal/indexDua') ?>">
                                <div class="icon trophy">
                                    <div class="content">
                                        <div class="symbol"></div>
                                        <h5>Evaluasi Dua(2)</h5>
                                        <span class="hr"></span>
                                        <p>Berbagi Layanan Jaringan</p>
                                    </div>
                                </div>
                        ...
                        <li class="columns">
                            <a href="<?php echo site_url('cSoal/indexTiga') ?>">
                                <div class="icon trophy">
                                    <div class="content">
                                        <div class="symbol"></div>
                                        <h5>Evaluasi Tiga(3)</h5>
                                        <span class="hr"></span>
                                        <p>Manajemen Backup dan Recovery </p>
                                    </div>
                                </div>
                        ...
                        <li class="columns last-child">
                            <a href="<?php echo site_url('cSoal/indexEmpat') ?>">
                                <div class="icon trophy">
                                    <div class="content">
                                        <div class="symbol"></div>
                                        <h5>Evaluasi Empat(4)</h5>
                                        <span class="hr"></span>
                                        <p>Manajemen Remote Access</p>
                                    </div>
                                </div>
