            ...
            <div class="container">
                ...
                <div class="standard">
                    ...
                    <div class="five column alpha">
                        <div class="logo">
                            <a href="http://www.um.ac.id/"><img src="<?php echo base_url()?>assets/images/logo-um.png" style="width: 40px; height: 40px" alt="logo um"></a>
                        </div>
                    </div>
                    ...
                    <div class="eleven column omega tabwrapper">
                        <div class="menu-wrapper">
                            <ul class="tabs menu">
                                <li>
                                    <a href="<?php echo base_url() ?>index.php/welcome/ "><i class="glyphicon glyphicon-home"> Beranda</i></a>

                                </li>
                                <li><a href="<?php echo base_url() ?>index.php/welcome/beranda" class="active"><i class="glyphicon glyphicon-list"> Pembelajaran</i></a>
                                    <ul class="child">
                                        <li><a href="<?php echo site_url('/cBabSatu/babSatu') ?>">Materi Satu(1): Sistem file dan user access pada linux</a>
                                        </li>
                                        <li><a href="<?php echo site_url('/cBabDua/babDua') ?>">Materi Dua(2): Berbagai Layanan Jaringan</a></li>
                                        <li><a href="<?php echo site_url('/cBabTiga/babTiga') ?>">Materi Tiga(3): Manajemen Backup dan Recovery</a></li>
                                        <li><a href="<?php echo site_url('/cBabEmpat/babEmpat') ?>">Materi Empat(4): Manajemen Remote Access</a></li>
                                    </ul>
                                </li>
                                <li><a href="<?php echo site_url('welcome/evaluasi') ?>"><i class="glyphicon glyphicon-expand"> Evaluasi</i></a>
                                    <ul class="child">
                                ...
                                <li><a href="<?php echo site_url('welcome/simulasi') ?>"><i class="glyphicon glyphicon-edit"> Simulasi</i></a>
                                </li>
                                <li><a href="<?php echo site_url('welcome/bantuan') ?>"><i class="glyphicon glyphicon-question-sign"> Bantuan</i></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
...
<h1> Anda Harus Login Dahulu Sebelum Menambah Soal</h1>